  ...
  Widget build(BuildContext context) {
    return FocusScope(
      onFocusChange: (result) {
        // 选中对应的内容
          print("PlutoGridState onFocusChange.....");
        _stateManager.setKeepFocus(result);
      },
      onKey: (FocusNode focusNode, RawKeyEvent event) {
        // 交互的事件（修改数据）
        print("PlutoGridState onKey.....");
        return _handleGridFocusOnKey(focusNode, event);
      },
      child:
        ...
        DecoratedBox(
          ...
          Padding(
            ...
            child: borderRadius == BorderRadius.zero
                ? child
                : ClipRRect(borderRadius: borderRadius, child:
